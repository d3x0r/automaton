...
<circle style="fill:url(&quot;#gradient-2n&quot;); fill-opacity: 0.68;" cx="69.539" cy="83.618" r="30.783" transform="matrix(1.062366, 0, 0, 1.046363, -8.38973, -7.437199)"></circle>
	...
	return svg;
      ...
      var svghtml = new XMLSerializer().serializeToString(image);
      console.log( svghtml );
			var svg = "data:image/svg+xml," 
      		+ encodeURI( svghtml )
          		.replace( /#/g, "%23" );
      
      //svg = "data:image/svg+xml;base64," + btoa(svghtml)
...
//divback.style.background="#eedd22";
var canvas = document.createElement( "canvas" );
canvas.width = 128;
canvas.height = 128;
canvas.style.width="100vh";
canvas.style.height="100vh";
divback.appendChild( canvas );
